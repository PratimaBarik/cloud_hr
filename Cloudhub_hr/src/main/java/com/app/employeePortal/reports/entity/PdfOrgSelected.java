...
@Getter
@Setter
@Table(name="pdf_org_selected")
public class PdfOrgSelected {

	@Id
	@GenericGenerator(name = "pdf_org_selected_id", strategy = "com.app.employeePortal.reports.generator.PdfOrgSelectedGenerator")
	@GeneratedValue(generator = "pdf_org_selected_id")
	
	@Column(name="pdf_org_selected_id")
	private String pdfOrgSelectedId;
