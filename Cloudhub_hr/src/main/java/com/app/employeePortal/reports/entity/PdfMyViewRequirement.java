...
@Getter
@Setter
@Table(name="pdf_myview_requirement")
public class PdfMyViewRequirement {

	@Id
	@GenericGenerator(name = "pdf_myview_requirement_id", strategy = "com.app.employeePortal.reports.generator.PdfMyViewRequirementGenerator")
	@GeneratedValue(generator = "pdf_myview_requirement_id")
	
	@Column(name="pdf_myview_requirement_id")
	...
	@Column(name="customer_ind",nullable=false)
	private boolean customerInd=false;
