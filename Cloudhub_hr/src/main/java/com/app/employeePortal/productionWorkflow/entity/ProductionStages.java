...
public class ProductionStages {
	...
	@Id
	@GenericGenerator(name = "production_stages_id", strategy = "com.app.employeePortal.productionWorkflow.generator.ProductionStagesGenerator")
    @GeneratedValue(generator = "production_stages_id")
	
	@Column(name="production_stages_id")
