package com.app.employeePortal.caffieneCache.controller;
...
public class CaffeineCacheController {
	   private final CacheManager cacheManager;
	    ...
	    public Map<String, Object> getEntriesForCache(@PathVariable(name = "cacheName") final String cacheName) throws IOException {
